...
const HeroSection = () => {
  ...
  return (
      <section className="relative bg-blue-900 text-white overflow-hidden h-screen">
        <BackgroundGradient />
        <div
        ...
        >
          {[...Array(3)].map((_, i) => (
              <motion.div
                  key={i}
                  className="absolute w-72 h-72 bg-blue-500 rounded-full"
                  style={{
                    left: `${20 + i * 30}%`,
                    top: `${20 + i * 20}%`,
                    filter: 'blur(100px)',
      ...
      {/*            <Button to="/projects" variant="primary">
                ...
                >
                  <Button
                      to="/contact"
                      variant="outline"
                      className="border-2 border-yellow-500 text-yellow-500 hover:bg-yellow-500 hover:text-blue-900 hover:shadow-lg hover:shadow-yellow-500/25 transition-all duration-300"
                  >
                    Consult with Us
                  </Button>
                </motion.div>
        ...
        <motion.div
            className="absolute bottom-[100px] left-1/2 transform -translate-x-1/2 cursor-pointer z-20 mr-[50%] md:mr-0"
