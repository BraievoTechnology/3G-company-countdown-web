            ...
            <Link to="/services" className="block h-full">
                ...
                <motion.div
                    ...
                    initial={{
                        opacity: 0.7,
                        background:
                            'linear-gradient(to top, rgba(30, 58, 138, 0.95) 0%, rgba(30, 58, 138, 0.8) 30%, rgba(30, 58, 138, 0.4) 60%, rgba(30, 58, 138, 0.2) 80%, rgba(30, 58, 138, 0) 100%)',
                    }}
                    whileHover={{
                        opacity: 0.9,
                    }}
    ...
    return (
        ...
        >
            <div className="relative h-full">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-b from-blue-900/20 via-blue-900/50 to-blue-900/90" />
