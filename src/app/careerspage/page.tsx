...
const benefits = [
  {
    ...
    description:
      "We welcome diverse perspectives and believe our strength lies in our people’s unique backgrounds and skills.",
  },
  {
    icon: <BarChart3 className="w-6 h-6 text-black" />,
    title: "Opportunities for Growth",
    description:
      "We invest in your professional development through training, project exposure, and a clear career progression path.",
  },
  {
    icon: <Handshake className="w-6 h-6 text-black" />,
    title: "Collaborative Culture",
    description:
      "Work in a team-oriented environment where knowledge-sharing, mentorship, and mutual respect drive our success.",
  },
  {
    icon: <BrainCircuit className="w-6 h-6 text-black" />,
    title: "Innovation-Driven Environment",
    description:
      "Tackle complex challenges using modern tools and cutting-edge practices in a forward-thinking consultancy setting.",
  },
];
const CareersPage = () => {
