            ...
            <div className="flex flex-wrap justify-center mb-12 gap-2">
              {projectCategories.map((category) => (
                  <button
                      ...
                      className={`px-6 py-2 rounded-full transition-colors duration-200 ${activeCategory === category ? 'bg-blue-900 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
                  >
                    {category}
                  </button>
              ))}
