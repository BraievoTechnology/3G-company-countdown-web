            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <p className="mb-4 mt-4 text-white">
                  ...
                  Surveying and Cost Consultancy services, Construction
                  Procurement and Claims Management, Highway Engineering, Water
                  Resource Engineering, Water Supply, and Sewerage Engineering and
                ...
                <p className="mb-4 text-white">
                  ...
                  Various types of procurement, Tender and Contract documentation,
                  Construction Supervision, Value Engineering, Post Contract
                  Administration, Claims Management and Dispute Resolution, and
                  Management Studies related to the construction industry, our
                  qualified and experienced team of experts has contributed to
                  many national & international projects with an unwavering
                ...
                <p className="mb-4 text-white">
                  ...
                  organizations throughout the years and understands the types of
                  projects we will be called to produce. We have our own internal
                  procedures in which we are fully equipped and trained, and we
                  adhere to the industry’s highest quality standards. We
                  understand compliance and we are able to hit the ground running
                  with any project we are integrated with the help of our
                ...
                <p className="text-white">
                  ...
                  while improving and conserving natural environments.
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              <div className="bg-white p-8 rounded-lg shadow-md">
                ...
                <p className="text-gray-700 mb-4 italic font-semibold">
                  ...
                  and become the 'go-to' consultancy, for project and construction
                  management both locally and globally, by building on our
                  strengths - innovative thinking, excellent quality assurance,
                  timely completion, state of the art technology, and exhibiting
